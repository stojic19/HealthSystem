...
@Component({
  selector: 'app-first-room-info',
  templateUrl: './first-room-info.component.html',
  styleUrls: ['./first-room-info.component.css']
})
export class FirstRoomInfoComponent implements OnInit {
  @Output()
